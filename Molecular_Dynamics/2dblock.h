...
/* README
 * 
 * This implementation is build on top of my assignment 3
 * Since now the atoms have velocities, I modified the structure
 * of each atom to be array<double,9> with a 8th and 9th component
 * to be v_x, and v_y. So now my atom looks like the following:
 * 
 * Atom(xposition,yposition, sigmaxx, sigmayy, sigmaxy, F_x, F_y,v_x,v_y) 
 * 
 * As always, thanks!
 */ 
...
//+++++++++++ A shot comment on the choice of delta_t: ++++++++++++++++++
//In class, we have learned that delta_t should be at least smaller than 
//1E-13 and a proper choice would be between 1E-14 and 1E-15.
//
//I have tried simulations for both delta_t = 1E-14 and 1E-15 for the first
//part of this assignment to minimize the potential energy using Molecular 
//dynamics. According to my simulations, it turns out the delta_t = 1E-14 
//is a better choice over 1E-15 due to a faster computation and better 
//results.(see details result in the report)
//
//Hence for the temperature dependence simulations, we set delta_t = 1E-14
